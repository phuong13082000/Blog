    ...
    <section class="flex">
        ...
        <div class="profile">
            ...
            if ($select_profile->rowCount() > 0) {
                ...
                <a href="update.php" class="btn">Cập nhật profile</a>
                <div class="flex-btn">
                    <a href="login.php" class="option-btn">login</a>
                    <a href="register.php" class="option-btn">register</a>
                </div>
                <a href="components/user_logout.php" onclick="return confirm('Bạn muốn đăng xuất khỏi website?');" class="delete-btn">Đăng xuất</a>
                <?php
            } else {
                ?>
                <p class="name">Trước tiên hãy đăng nhập!</p>
