...
<section class="dashboard">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p>Các bài đã đăng</p>
            <a href="add_posts.php" class="btn">Thêm bài mới</a>
        </div>
        ...
        <div class="box">
            ...
            <p>Bài viết hiện có (không ẩn)</p>
            <a href="view_posts.php" class="btn">Xem tất cả</a>
        </div>
        ...
        <div class="box">
            ...
            <p>Các comments</p>
            <a href="comments.php" class="btn">Xem tất cả</a>
        </div>
