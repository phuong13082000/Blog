        ...
        if ($select_likes->rowCount() > 0) {
            while ($fetch_likes = $select_likes->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($select_posts->rowCount() > 0) {
                            ...
                            <form class="box" method="post">
                                ...
                                <div class="icons">
                                    ...
                                    <button type="submit" name="like_post">
                                        <i class="fas fa-heart" style="<?php if ($total_post_likes > 0 and $user_id != '') {
                                            echo 'color:red;';
                    ...
                    echo '<p class="empty">Không có bài viết nào liên quan đến danh mục này!</p>';
                }
            }
        } else {
            echo '<p class="empty">Bài viết này chưa từng được like!</p>';
        }
        ?>
    </div>
