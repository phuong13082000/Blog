...
if (isset($_POST['add_comment'])) {
    ...
    if ($verify_comment->rowCount() > 0) {
        $message[] = 'comment đã được thêm vào!';
    } else {
        ...
        $message[] = 'comment mới đã được thêm vào added!';
    }
...
if (isset($_POST['open_edit_box'])) {
    ...
    <section class="comment-edit-form">
        ...
        <form action="" method="POST">
            ...
            <button type="submit" class="inline-btn" name="edit_comment">Sửa comment</button>
...
<section class="comments-container">
    ...
    <p class="comment-title">Thêm comment</p>
    <?php
    if ($user_id != '') {
        ...
        <div class="add-comment">
            <p>Thêm hoặc sửa comment sau khi đăng nhập</p>
    ...
    <p class="comment-title">Tất cả comment trong bài viết</p>
    <div class="user-comments-container">
        ...
        if ($select_comments->rowCount() > 0) {
                ...
                <div class="show-comments" style="<?php if ($fetch_comments['user_id'] == $user_id) {
                    ...
                    if ($fetch_comments['user_id'] == $user_id) {
                        ...
                        <form action="" method="POST">
                            ...
                            <button type="submit" class="inline-option-btn" name="open_edit_box">Sửa comment</button>
                            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('delete this comment?');">
                                Xóa comment
                            </button>
                        </form>
                        <?php
            ...
            echo '<p class="empty">Không có comment nào được thêm vào!</p>';
        }
        ?>
    </div>
