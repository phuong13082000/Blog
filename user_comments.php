...
if (isset($_POST['edit_comment'])) {
    ...
    if ($verify_comment->rowCount() > 0) {
        ...
        $message[] = 'comment của bạn đã sửa!';
    }
...
<section class="comments-container">
    ...
    <h1 class="heading">Comment của bạn</h1>

    <p class="comment-title">Comment của bạn trên tất cả bài viết</p>
            ...
            while ($fetch_comments = $select_comments->fetch(PDO::FETCH_ASSOC)) {
                ...
                <div class="show-comments">
                    ...
                    while ($fetch_posts = $select_posts->fetch(PDO::FETCH_ASSOC)) {
                        ?>
                        <div class="post-title"> Từ : <span><?= $fetch_posts['title']; ?></span>
                            <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>">Xem bài viết</a></div>
                        <?php
                    }
                    ?>
